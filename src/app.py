...
from mcp_server import MCPJobApplicationServer
from prompts import (
...
def run_react_agent(user_query: str, provider, mcp_server: MCPJobApplicationServer) -> list:
    """
    ...
    while step < MAX_ITERATIONS:
        ...
        llm_response = provider.generate_with_tools(agent_query, tools_list, system_prompt=REACT_AGENT_SYSTEM_PROMPT)
        ...
        # Trường hợp 2: LLM đề xuất gọi Tool (Action)
            ...
            print("🧠 [Thought]: Đã nhận Observation. Chuyển sang lượt suy luận kế tiếp.")
            continue
...
if __name__ == "__main__":
    print("==========================================================")
    print("💼 SMART JOB APPLICATION AGENT - DAY 03 LAB")
    print("==========================================================")
    
    provider = get_llm_provider()
    mcp_server = MCPJobApplicationServer()
    ...
    if "--interactive" in sys.argv:
        ...
        print("   - Tra cứu: 'Hãy tra cứu trạng thái hồ sơ tại Vingroup'")
        print("   - Cập nhật và đặt lịch: 'Xử lý hồ sơ Data Analyst tại Vingroup và đặt lịch 18/09/2026'")
        ...
        print(f"--- 🏁 DEMO CHẠY THỬ 1 TEST CASE MẪU (TC02: Tra cứu hồ sơ) ---")
